...
**Liberals:** AP (64%) → CNN (28%) → ChatGPT (7%) → FOX (\<1%) **Conservatives:** FOX (44%) → CNN (21%) → ChatGPT (21%) → AP (15%)
...
### Source × AI Neutrality coefficient-level checks

The table below reports the specific two-way coefficient terms from the controlled H4 simplified models. ChatGPT is the reference source, so each term tests whether the AI Neutrality slope for that source differs from the AI Neutrality slope for ChatGPT. Only p \< .05 terms are labeled **Significant**.

| DV | NS × AI Neutrality | FOX × AI Neutrality | CNN × AI Neutrality | AP × AI Neutrality |
|----|----|----|----|----|
| Perceived Bias, signed | b = .065, p = .314, n.s. | b = -.099, p = .125, n.s. | b = .0003, p = .996, n.s. | b = .012, p = .850, n.s. |
| Perceived Bias, absolute | b = .033, p = .498, n.s. | b = -.012, p = .808, n.s. | b = .005, p = .915, n.s. | b = -.037, p = .452, n.s. |
| Credibility | b = -.134, p = .031, **Significant** | b = -.059, p = .347, n.s. | b = -.075, p = .231, n.s. | b = -.137, p = .029, **Significant** |
| Agreement | b = -.006, p = .943, n.s. | b = .075, p = .335, n.s. | b = -.103, p = .183, n.s. | b = .036, p = .644, n.s. |
| Action Intent | b = -.083, p = .068, n.s. | b = -.060, p = .188, n.s. | b = -.113, p = .014, **Significant** | b = -.092, p = .044, **Significant** |

**Interpretation:** The source-specific AI Neutrality moderation is not consistent across outcomes. At the coefficient level, significant terms appear for credibility (NS and AP) and action intent (CNN and AP), but FOX × AI Neutrality is not significant for any DV.

**Notable coefficient-level findings:** - Three-way interactions not significant in any model.
